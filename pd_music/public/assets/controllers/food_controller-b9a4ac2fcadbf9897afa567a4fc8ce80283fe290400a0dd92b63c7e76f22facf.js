...
export default class extends Controller {
        ...
        if (!arr_valid.includes(false)){
            ...
            create_restaurant.then((data) => {
                try{
                    ...
                    if (document.getElementById("update-restaurant-id").value == ""){
    ...
    editRestaurant(event){
        ...
        document.getElementById("btn-create-restaurant").innerHTML = "Update";
    }
    ...
    clearDefault(){
        ...
        document.getElementById("btn-create-restaurant").innerHTML = "Create";
    }
