...
export default class extends Controller {
    ...
    confirmOrder(event){
        ...
        const create_option = fetch(url, {
            ...
            body: JSON.stringify({"id": update_id.value, "menu_id": menu_id.value, "date": date.value, "detail": detail.value, "option": JSON.stringify(optional), "has_second": has_second, "second_menu_id": second_menu_id, "price": price}),
          }).then(response => {
            if (response.ok) {
              return response.text();
            }
