...
export default class extends Controller {
    connect() {
        ...
        let force_add_dialog = document.getElementById("force-add-subject-dialog");
        if (force_add_dialog != null){
            $("#force-add-subject-dialog").modal("show");
        }
    ...
    filterReportSubject(){
        let selected_subject = document.getElementById("select-subject");
        let selected_classroom = document.getElementById("select-class");
        let selected_room = document.getElementById("select-room");
        ...
        const subject = fetch(url, {
            ...
            body: JSON.stringify({ "id": selected_subject.value, "class": selected_classroom.value, "room": selected_room.value}),
        }).then(response => {
            if (response.ok) {
              return response.text();
            }
    ...
    filterReportEvent(){
        ...
        let selected_classroom = document.getElementById("select-event-class");
        let selected_room = document.getElementById("select-event-room");
        ...
        const event = fetch(url, {
            ...
            body: JSON.stringify({"event_id": selected_event.value, "class": selected_classroom.value, "room": selected_room.value}),
        }).then(response => {
            if (response.ok) {
              return response.text();
            }
