    ...
    showMenu(){
        ...
        let table = $("#table-menu-list").DataTable({
            ...
            rowCallback: function (row, data) {
                ...
                $('td:eq(0)', row).setAttribute("data-bs-target", "#addMenuBackdrop");
                $('td:eq(0)', row).setAttribute("data-action", "click->menu#editMenu");
                let menu = data.menuName.split(" ")[0];
                $('td:eq(0)', row).setAttribute("data-menu-menu-param", menu);
                $('td:eq(0)', row).setAttribute("data-menu-restaurant-id-param", restaurant_id.value);
            }
