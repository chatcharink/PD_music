...
export default class extends Controller {
  ...
  filter(){
    if( $("#div-filter-user").css('display') == 'none'){
      $("#div-filter-user").slideDown("slow");
    } else {
      $("#div-filter-user").slideUp("slow");
    }
  }
  ...
  onUpdateUser(event){
    ...
    if (!valid_phonenumber){
      ...
      this.alert("error", "Phone number should not be empty or invalid telephone number length");
    }else{
      all_valid.push("true");
    ...
    if (!valid_email){
      ...
      this.alert("error", "Email should not be empty or invalid email pattern");
    }else{
      all_valid.push("true");
  ...
  setDeleteId(event){
    ...
    document.getElementById("delete-user-name").innerHTML = ": "+name;
    document.getElementById("confirm-delete-user").setAttribute("data-id", id);
    document.getElementById("confirm-delete-user").setAttribute("data-name", name);
  }

  deleteSubject(){
    let id = document.getElementById("confirm-delete-user").getAttribute("data-id");
    let name = document.getElementById("confirm-delete-user").getAttribute("data-name");
    let application_path = document.getElementById("application-path");
    let url = application_path.value+"/user/"+id
